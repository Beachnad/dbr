...
db_light_theme <- function(base_size = 12,
  ...
  theme_bw(base_size = base_size, base_family = base_family,
    ...
    theme(text = element_text(family = base_family),
          ...
          plot.margin = ggplot2::margin(t=12, r=6, b=12, l=6),
          ...
          strip.text = element_text(colour = "grey10", size = rel(0.8), margin = ggplot2::margin(0.8 * half_line, 0.8 * half_line, 0.8 * half_line, 0.8 * half_line), face='bold'),
